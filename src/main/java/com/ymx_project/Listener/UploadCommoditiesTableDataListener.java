...
@Slf4j
public class UploadCommoditiesTableDataListener implements ReadListener<CommoditiesTable> {
     ...
     */
    public UploadCommoditiesTableDataListener(CommoditiesTableRepository commoditiesTableRepository) {
...
//            log.info("cachedDataList:{}",cachedDataList.size());
            saveData();
            // 存储完成清理 list
...
//        log.info("{}条数据，开始存储数据库！", cachedDataList.size());
        ...
        while(it.hasNext()) {
            CommoditiesTable commoditiesTable = it.next();
