...
import com.ymx_project.entity.TortGoods;

import com.ymx_project.repository.TortGoodsRepository;
...
@Slf4j
public class UploadTortGoodsDataListener implements ReadListener<TortGoods> {
    ...
    private List<TortGoods> cachedDataList = ListUtils.newArrayListWithExpectedSize(BATCH_COUNT);
    /**
     ...
     *
     * @param tortGoodsRepository
     */
    public UploadTortGoodsDataListener(TortGoodsRepository tortGoodsRepository) {
        this.tortGoodsRepository = tortGoodsRepository;
    }
     ...
     */
    @Override
    public void invoke(TortGoods data, AnalysisContext context) {
    ...
    private void saveData() {
        ...
        Iterator<TortGoods> it = cachedDataList.iterator();
        while(it.hasNext()) {
            TortGoods tortGoods = it.next();
            tortGoods.setAsinLink(asinToJavaData);
