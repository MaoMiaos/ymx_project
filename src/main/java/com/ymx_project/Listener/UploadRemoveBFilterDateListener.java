...
public class UploadRemoveBFilterDateListener implements ReadListener<FilterDataDto> {
     ...
     */
    public UploadRemoveBFilterDateListener(ForbidGoodsRepository forbidGoodsRepository) {
    ...
    private void saveData() {
        ...
        while(it.hasNext()) {
            FilterDataDto filterDataDto = it.next();
            filterDataDto.getAsin();
            filterDataDto.getBrand();
