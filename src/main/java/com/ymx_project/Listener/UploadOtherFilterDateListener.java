...
public class UploadOtherFilterDateListener implements ReadListener<FilterDataDto> {
    ...
    private List<FilterDataDto> cachedDataList = ListUtils.newArrayListWithExpectedSize(BATCH_COUNT);
    /**
    ...
    private RemoveARepository removeARepository;
    private ReSelectRepository reSelectRepository;
    private CommoditiesTableRepository commoditiesTableRepository;
    private NewCommoditiesRepository newCommoditiesRepository;
    private TortGoodsRepository tortGoodsRepository;
    /**
     * 如果使用了spring,请使用这个构造方法。每次创建Listener的时候需要把spring管理的类传进来
     *
     * @param forbidGoodsRepository
     */
    public UploadOtherFilterDateListener(ForbidGoodsRepository forbidGoodsRepository) {
     ...
     */
    @Override
    public void invoke(FilterDataDto data, AnalysisContext context) {
    ...
    private void saveData() {
        ...
        Iterator<FilterDataDto> it = cachedDataList.iterator();
        while(it.hasNext()) {
